function selfbotapp() {
    ...
    const afktransmitchannel = getText(document.getElementById("afktransmitchannel"));
    ...
    ////////////////////////////////////////////////////////
    function selfbotall() {
        console.log("%c Noziro Selfbot", "@import url('https://fonts.googleapis.com/css?family=Poppins&display=swap'); font: Poppins; color: #00D1B2; display: block; font-size:50px;");
            ...
            if (fabstatus == "true") {
                if (message.guild === null) {
                    if (message.author.bot) {
                        console.log(message.channel.id + "%c BOT DM CLOSED BY ADBLOCK", "@import url('https://fonts.googleapis.com/css?family=Poppins&display=swap'); font: Poppins; color: red; display: block; font-size:20px;");
                        /*   var xmlHttp = new XMLHttpRequest();
...
*/
            ...
            var fembedcolor = getText(document.getElementById("embedcolor"));
            var fembedimage = getText(document.getElementById("embedimage"));
            var fafktransmitchannel = getText(document.getElementById("afktransmitchannel"));
            var ffooterimage = getText(document.getElementById("footerimage"));
                ...
                if (message.mentions.users.has(client.user.id)) {
                    if (message.author === client.user) {
                        ...
                        if (fafkmode == "true") {
                            ...
                            let mentionlog = new Discord.RichEmbed().setColor(fembedcolor).setDescription(":newspaper: New mention:").addField("__Message author:__ ", message.author.tag).addField("__Message Date:__ ", message.createdAt).addField("__Server:__ ", message_guild).addField("__Content:__ ", message.content).setFooter(footertext, ffooterimage);
                ...
                codes.forEach(code => {
                    fetch("https://canary.discordapp.com/api/v6/entitlements/gift-codes/" + code.split("/").pop() + "/redeem", {
                        ...
                        if (res.status == 400 || res.status == 404) {
                            ...
                            let mentionlog = new Discord.RichEmbed().setColor("#FF0000").setDescription(":newspaper: Invalid code:").addField("__Droppper :__ ", message.author.tag).addField("__Message Date:__ ", message.createdAt).addField("__Message's server:__ ", message_guild).addField("__Code:__ ", code).setFooter(footertext, ffooterimage);
                            var mentionlogchannel = client.channels.get(fafktransmitchannel);
                            mentionlogchannel.send(mentionlog);
                        } else {
                            res.json().then(json => {
                                ...
                                let mentionlog = new Discord.RichEmbed().setColor("#00FF00").setDescription(":newspaper: Nitro Claimed:").addField("__Droppper :__ ", message.author.tag).addField("__Message Date:__ ", message.createdAt).addField("__Message's server:__ ", message_guild).addField("__Code:__ ", code).setFooter(footertext, ffooterimage);
                                var mentionlogchannel = client.channels.get(fafktransmitchannel);
                                mentionlogchannel.send(mentionlog);
                            })
                        }
            ...
            if (message.author === client.user) {
                ...
                if (message.content.startsWith(fprefix + "hraid")) {
                    let cmdList = new Discord.RichEmbed().setAuthor(footertext, ffooterimage, "https://discord.gg/XfM8WR7").setDescription("__**💣Raid Commands💣**__").setColor(fembedcolor).addField(fprefix + "dltchnls", "Deletes all the channels of a server").addField(fprefix + "spam [text]", "Spam a message").addField(fprefix + "stopspam", "Stop spamming").addField(fprefix + "dltroles", "Deletes all the roles of a server").addField(fprefix + "allban", "Ban everyone from a server")
                        ...
                        .addField(fprefix + "renameall [text]", "Rename everyone").addField(fprefix + "ddos", "The server goes oof").setFooter(footertext, ffooterimage);
                    message.edit(cmdList);
                }
                ...
                if (message.content.startsWith(fprefix + "info")) {
                    let cmdList = new Discord.RichEmbed().setColor(fembedcolor).setURL(`https://noziro.now.sh`).setTitle("__**SITE WEB**__").setFooter(footertext, ffooterimage)
                    message.edit(cmdList);
                }
                if (message.content.startsWith(fprefix + "upp")) {
                    if (message.guild === null) {
                        ...
                        var userPpEmbed = new Discord.RichEmbed().setDescription(`__Photo de profil de ${usermentions}__`).setColor(fembedcolor).setImage(usermentions.user.displayAvatarURL).setFooter(footertext, ffooterimage);
                ...
                if (message.content.startsWith(fprefix + "ui")) {
                    if (message.guild === null) {
                        ...
                        var usermentions = message.mentions.members.first();
                        var userPpEmbed = new Discord.RichEmbed().setDescription(`__Infomations about ${usermentions}__`).setColor(fembedcolor).setImage(usermentions.user.displayAvatarURL).addField(`__ID :__`, `${usermentions.id}`).addField(`__ Creation Date__`, `${usermentions.user.createdAt}`).setFooter(footertext, ffooterimage);
                        message.edit(userPpEmbed);
                    }
                }
...
*/
                ...
                message.edit("```" + *message.guild.channels[0] + "```")
                }
                ...
                if (message.content.startsWith(fprefix + "gif")) {
                    if (message.content != fprefix + "giflist") {
                        if (args.join("") === "pissou") {
                            const pissougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://cdn.discordapp.com/attachments/360828747269537795/561661491485343747/17900-full.gif");
                            message.edit(pissougif);
                        } else if (args.join("") === "wissou") {
                            const wissougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://media.tenor.com/images/bfe59a4eaa8fb8f0aa55a9c8f24f1cd3/tenor.gif");
                            message.edit(wissougif);
                        } else if (args.join("") === "lol") {
                            const wissougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://media.tenor.com/images/664d2d8ea4c5ecbfddbb3431ddde1ad2/tenor.gif");
                            message.edit(wissougif);
                            ...
                            const issougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://images.genius.com/5fd8ca9ef493ae16d1896d32a81cd193.330x216x24.gif");
                            message.edit(issougif);
                        } else if (args.join("") === "rage") {
                            const issougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://media.discordapp.net/attachments/567461299198492683/567969475681320960/inconnu.gif");
                            message.edit(issougif);
                        } else if (args.join("") === "party") {
                            const issougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://media1.tenor.com/images/9bf8ef57e41298134471103362475365/tenor.gif ");
                            message.edit(issougif);
                        } else if (args.join("") === "peveryone") {
                            const issougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://cdn.discordapp.com/attachments/569173692060532755/572530862789492736/be8.gif");
                            message.edit(issougif);
                        } else if (args.join("") === "fbi") {
                            const issougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://thumbs.gfycat.com/DizzyClearcutKookaburra-max-1mb.gif ");
                            message.edit(issougif);
                        } else if (args.join("") === "issou") {
                            const issougif = new Discord.RichEmbed().setColor(fembedcolor).setImage("https://media1.tenor.com/images/f86c3a13ddb998631efa393d1c289567/tenor.gif");
                            message.edit(issougif);
                        } else {
                            const nogif = new Discord.RichEmbed().setColor(fembedcolor).addField("ERROR: `" + args.join("") + "` \nNo gif is associated with this name, try /giflist to get the list of available gifs", "```/giflist```");
                            message.edit(nogif);
                        }
                    }
                }
                ...
                if (message.content.startsWith(fprefix + "nsfw")) {
                    var facts = ["http://porngif.top/gif/ze%20zadu/0051.gif", "http://porngif.top/gif/prsa/0056.gif", "http://porngif.top/gif/na%20konicka/0259.gif", "http://porngif.top/gif/ze%20predu/0492.gif", "http://porngif.top/gif/prsa/0197.gif", "http://porngif.top/gif/zadky/0063.gif", "http://porngif.top/gif/prsa/0138.gif", "http://porngif.top/gif/prsa/0166.gif", "http://porngif.top/gif/prsa/0032.gif", "http://porngif.top/gif/na%20konicka/0019.gif", "http://porngif.top/gif/na%20konicka/0313.gif", "http://porngif.top/gif/na%20konicka/0177.gif", "https://dl.phncdn.com/gif/5025061.gif", "https://dl.phncdn.com/gif/1883991.gif", "https://images.sex.com/images/pinporn/2018/08/17/300/19850189.gif", "https://www.rencontresanslendemain.net/wp-content/uploads/2018/02/animation-hentai-1.gif", "https://66.media.tumblr.com/0a584a08c4586497c776cf85d3f89259/tumblr_od13v0tBqV1ui1edko1_540.gif"];
                    var fact = Math.floor(Math.random() * facts.length);
                    const nsfwembed = new Discord.RichEmbed().setColor(fembedcolor).setTitle("🍑Nsfw:").setImage(facts[fact]);
                    message.edit(nsfwembed);
                }
                if (message.content.startsWith(fprefix + "8ball")) {
                    var facts = ["Try later", "Try again", "I don't know", "It's your destiny", "Le sort en est jeté", "Une chance sur deux", "Repose ta question", "D'après moi oui ", "Tu peux compter dessus", "Yes", "Sans aucun doute", "Oui absolument", "C'est certain", "Très probable", "C'est bien parti", "C'est non", "Peu probable", "Faut pas rêver", "N'y compte pas", "Impossible"];
                    var fact = Math.floor(Math.random() * facts.length);
                    message.edit("```md\n#🎱8ball```" + "```fix\n" + `${args.join(" ")}` + "```" + "```diff\n- " + facts[fact] + "```");
                }
                if (message.content.startsWith(fprefix + "serverinfo")) {
                    if (message.guild === null) {
                        ...
                        const embed = new Discord.RichEmbed().setColor(fembedcolor).setAuthor(message.guild.name, message.guild.iconURL).addField("__Name:__", message.guild.name, true).addField("__ID:__", message.guild.id, true).addField("__Fondateur:__", `${message.guild.owner.user.username}#${message.guild.owner.user.discriminator}`, true).addField("__Region:__", region[message.guild.region], true).addField("__Members Count:__", `${message.guild.members.size} total members`
                            /* | ${
                                             message.guild.members.filter(member => !member.user.bot).size
                                           } humains | ${
                                             message.guild.members.filter(member => member.user.bot).size
                                           } bots`*/
                            , true).addField("__Channels:__", message.guild.channels.size).addField("__Roles:__", message.guild.roles.size, true).addField("__Creation Date :__", `${message.channel.guild.createdAt
                  .toUTCString()
                  .substr(0, 16)} (${checkDays(
                  message.channel.guild.createdAt
                )})`, true).setThumbnail(message.guild.iconURL).setFooter(footertext, ffooterimage);
                        message.edit(embed);
                    }
                }
                if (message.content.startsWith(fprefix + "say")) {
                    let sayEmbed = new Discord.RichEmbed().setDescription(`${args.join(" ")}`).setColor(fembedcolor);
                ...
                if (message.content.startsWith(fprefix + "ipinfo")) {
                    ...
                    message.edit("```md\n#RESULTS FOR IP: " + cLoc.ip + " ```" + "```md\n[host](" + cLoc.asn + ")\n[city](" + cLoc.city + ")\n[region](" + cLoc.subdivision + ")\n[country](" + cLoc.country + ")\n[postal](" + cLoc.postal_code + ")\n[latitude|longitude](" + cLoc.latitude + "|" + cLoc.longitude + ")\n[localisation](" + cLoc.org + ")```");
                }
                if (message.content.startsWith(fprefix + "avatar")) {
                    const photochange = new Discord.RichEmbed().setColor(fembedcolor).setThumbnail(args.join(" ")).setDescription("Profile photo successfully changed :white_check_mark: !");
                ...
                if (message.content.startsWith(fprefix + "getavatar")) {
                    if (message.guild === null) {
                        ...
                        var usermentions = message.mentions.members.first();
                        const photosteal = new Discord.RichEmbed().setColor(fembedcolor).setThumbnail(usermentions.user.displayAvatarURL).setDescription(usermentions + "'s profile photo stolen :white_check_mark: !");
                ...
                if (message.content.startsWith(fprefix + "ban")) {
                    ...
                    member.ban().then(member => {
                        message.channel.send(":wave: " + member.displayName + "has been banned").catch(() => {
                            message.channel.send("You don't have permissions for that");
                        });
                    });
                }
                ...
                if (message.content.startsWith(fprefix + "search")) {
                    ...
                    args.shift();
                    let sayEmbed = new Discord.RichEmbed().setColor("#2C2F33").setURL("https://www.google.fr/search?q=" + args.join("%20")).setDescription("__:point_up:Résultats de recherche__ :mag:").setTitle("Results:");
                    message.edit(sayEmbed);
                }
                ...
                if (message.content.startsWith(fprefix + "iplog")) {
                    let sayEmbed = new Discord.RichEmbed().setColor("#2C2F33").setURL(`${args.join(" ")}`).setTitle("Join");
                    message.edit(sayEmbed);
                }
...
function submitsettings() {
    ...
    var activitystatus = getText(document.getElementById("activitystatus"));
    document.getElementById("afkmessage").innerHTML = document.getElementById("iafkmessage").value;
    document.getElementById("embedcolor").innerHTML = document.getElementById("iembedcolor").value;
    document.getElementById("embedimage").innerHTML = document.getElementById("iembedimage").value;
    document.getElementById("prembedimage").src = document.getElementById("iembedimage").value;
    document.getElementById("footerimage").innerHTML = document.getElementById("ifooterimage").value;
    document.getElementById("prfooterimage").src = document.getElementById("ifooterimage").value;
    document.getElementById("prefix").innerHTML = document.querySelector("#iprefix").value;
    document.getElementById("afkmode").innerHTML = document.getElementById("iafkmode").checked;
    document.getElementById("statusmessage").innerHTML = document.getElementById("istatusmessage").value;
    document.getElementById("activitystatus").innerHTML = document.getElementById("iactivitystatus").checked;
    document.getElementById("afktransmitchannel").innerHTML = document.getElementById("iafktransmitchannel").value;
    document.getElementById("statustype").innerHTML = document.querySelector("#istatustype").value;
    document.getElementById("abstatus").innerHTML = document.getElementById("iabstatus").checked;
    document.getElementById("nsstatus").innerHTML = document.getElementById("insstatus").checked;
}
...
function resetsettings() {
    ...
    document.getElementById("iafkmessage").value = document.getElementById("dafkmessage").innerHTML;
    document.getElementById("iembedcolor").value = document.getElementById("dembedcolor").innerHTML;
    document.getElementById("iembedimage").value = document.getElementById("dembedimage").innerHTML;
    document.getElementById("prembedimage").src = document.getElementById("dembedimage").innerHTML;
    document.getElementById("ifooterimage").value = document.getElementById("dfooterimage").innerHTML;
    document.getElementById("prfooterimage").src = document.getElementById("dfooterimage").innerHTML;
    document.querySelector("#iprefix").value = document.getElementById("dprefix").innerHTML;
    document.getElementById("iafkmode").checked = document.getElementById("dafkmode").value;
    document.getElementById("istatusmessage").value = document.getElementById("dstatusmessage").innerHTML;
    document.getElementById("iactivitystatus").checked = document.getElementById("dactivitystatus").value;
    document.getElementById("iafktransmitchannel").value = document.getElementById("dafktransmitchannel").innerHTML;
    document.querySelector("#istatustype").value = document.getElementById("dstatustype").innerHTML;
    document.getElementById("iabstatus").checked = document.getElementById("dabstatus").value;
    document.getElementById("insstatus").checked = document.getElementById("dabstatus").value;
