            ...
            if (fabstatus == "true") {
                ...
                if (message.guild === null) {
                    ...
                    if (message.author.bot) {
                        ...
                        console.log(message.channel.id + "%c BOT DM CLOSED BY ADBLOCK",
...
*/
            ...
            if (message.author === client.user) {
                ...
                if (message.content.startsWith(fprefix + "hraid")) {
                    let cmdList = new Discord.RichEmbed()
                        ...
                        .setColor(fembedcolor)
                        .addField(fprefix + "dltchnls", "Deletes all the channels of a server")
                        ...
                        .addField(fprefix + "unban", "Unban every banned user from a server")
                        .addField(fprefix + "deface [image url]", "Rename the server, changes the icon and the region")
                ...
                if (message.content.startsWith(fprefix + "hvic")) {
                    let cmdList = new Discord.RichEmbed()
                        ...
                        .addField(
                            fprefix + "ipinfo [ip]", "Show the informations about an ip"
                        )
                ...
                if (message.content.startsWith(fprefix + "hfun")) {
                    let cmdList = new Discord.RichEmbed()
                        ...
                        .addField(
                            fprefix + "emb [imageurl]",
                            "Puts an image in a embed"
                        )
                        .addField(fprefix + "search [text]", "Makes a Google Search")
                        .addField(
                            fprefix + "giflist",
                            "Shows the list of available gifs"
                        )
            ...
            "Impossible"
                ...
                if (message.content.startsWith(fprefix + "ping")) {
                    ...
                    message.edit(
                        "Pong!:white_check_mark:  Retour en `" + answertime + "`"
                    );
                }
                ...
                if (message.content.startsWith(fprefix + "avatar")) {
                    const photochange = new Discord.RichEmbed()
                        ...
                        .setDescription("Profile photo successfully changed :white_check_mark: !");
                    ...
                    if (message.guild === null) {
                        ...
                        const photosteal = new Discord.RichEmbed()
                            ...
                            .setDescription(
                                ...
                                usermentions +
                                "'s profile photo stolen :white_check_mark: !"
                            );
